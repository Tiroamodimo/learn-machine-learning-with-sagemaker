...
# chmod +x "learn-machine-learning-with-sagemaker/my-experiments/chapter02/03_01a run_test_train_container.sh"
...
sudo docker run --name pytrain --rm -v /opt/ml:/opt/ml $IMAGE_NAME:$TAG train

 # run command below in terminal to run this script from project root folder
# ./"learn-machine-learning-with-sagemaker/my-experiments/chapter02/03_01a run_test_train_container.sh"
